    ...
    <table cellpadding="0" cellspacing="0">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $ticket->has('categoria') ? $this->Html->link($ticket->categoria->descricao, ['controller' => 'Categorias', 'action' => 'view', $ticket->categoria->id]) : '' ?></td>
                <td><?= $ticket->has('subcategoria') ? $this->Html->link($ticket->subcategoria->descricao, ['controller' => 'Subcategorias', 'action' => 'view', $ticket->subcategoria->id]) : '' ?></td>
                <td class="actions">
